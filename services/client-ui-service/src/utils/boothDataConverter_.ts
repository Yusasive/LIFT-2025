...
'Household Cosmetics & Textile Products': {
  ...
  passages: [
    ...
    // Horizontal passages for Groups 1-4 (between upper and lower segments)
    { 
      type: 'horizontal', 
      position: 12,  // After row 12 (where HCT104, HCT204, etc. end)
      label: 'PASSAGE', 
      startColumn: 1, 
      endColumn: 11  // Covers columns 1-11 (Groups 1-4)
    },
    
    // Horizontal passages for Group 5
    { 
      type: 'horizontal', 
      position: 12,  // Between upper (HCT501-504) and middle segments
      label: 'PASSAGE', 
      startColumn: 13, 
      endColumn: 14 
    },
    { 
      type: 'horizontal', 
      position: 16,  // Between middle (HCT505-512) and lower segments
      label: 'PASSAGE', 
      startColumn: 13, 
      endColumn: 14 
    },
    
    // Horizontal passages for Group 6
    { 
      type: 'horizontal', 
      position: 12,  // Between upper (HCT601-604) and middle segments
      label: 'PASSAGE', 
      startColumn: 16, 
      endColumn: 17 
    },
    { 
      type: 'horizontal', 
      position: 16,  // Between middle (HCT605-612) and lower segments
      label: 'PASSAGE', 
      startColumn: 16, 
      endColumn: 17 
    }
...
'Food, Drinks, Agriculture & Allied Products': {
  ...
  rows: 4,
  columns: 25, // 17 booth columns + 8 passages
  passages: [
    ...
    { 
        ...
        position: 25, 
        label: 'ROAD 4',
        startColumn: 1,  // New property
        endColumn: 21     // New property
      }
  ],
...
'Africa Hall': {
 ...
 'Hall B': {
  rows: 19,  // 18 actual rows (passage creates visual row 8)
  columns: 9, // 6 booth columns + 3 passage columns
  passages: [
    { 
      type: 'vertical', 
...
// In convertHallAToGrid function, update the mapping:
...
const boothMapping: { [key: string]: { row: number; col: number } } = {
  ...
  // Column 2 (Grid column 3) - IMMEDIATELY AFTER PASSAGE
  'N016': { row: 2, col: 3 },
  'N015': { row: 3, col: 3 },
  'N014': { row: 4, col: 3 },
  'N013': { row: 6, col: 3 },
  ...
  // Column 2b (Grid column 4) - NO GAP, ADJACENT TO COLUMN 3
  'N023': { row: 2, col: 4 },
  'N022': { row: 3, col: 4 },
  'N021': { row: 4, col: 4 },
  'N020': { row: 6, col: 4 },
  ...
  // Column 3a (Grid column 6) - AFTER SECOND PASSAGE
  'N030': { row: 2, col: 6 },
  'N029': { row: 3, col: 6 },
  'N028': { row: 4, col: 6 },
  'N027': { row: 6, col: 6 },
  ...
  // Column 3b (Grid column 7) - NO GAP, ADJACENT TO COLUMN 6
  'N037': { row: 2, col: 7 },
  'N036': { row: 3, col: 7 },
  'N035': { row: 4, col: 7 },
  'N034': { row: 6, col: 7 },
